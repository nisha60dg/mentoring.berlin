...
/**
 * Class Mentoring_Orders
 *
 * 
 */
class Mentoring_Orders extends Mentoring_CURL
{
	 ...
	 * @var    string
	 */
	public function _createOrder($data)
	{
		$args = array(
			'service'  =>  $this->api_version . $this->service,
		);
	 ...
	 * @var    string
	 */
	public function _updateOrder($order_id, $data)
	{
		if (empty($order_id))
			return false;
		...
		$query_string_array = !empty($order_id) ? $order_id : '';
